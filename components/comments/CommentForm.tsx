...
import { SendIcon, UserCircleIcon, SpinnerIcon } from '../icons';
...
const CommentForm: React.FC<CommentFormProps> = ({ onSubmit, onCancel, placeholder="أضف تعليقك هنا..." }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // The error is already logged and alerted to the user by the `addComment` function.
            // We catch it here just to prevent an unhandled promise rejection warning in the console.
            // The form fields are NOT reset on error, allowing the user to copy their text.
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mt-3 gap-3">
                ...
                <div className="flex items-center gap-2 self-end">
                    ...
                    <button 
                        ...
                        className="px-4 py-2 bg-primary text-white font-semibold rounded-md hover:bg-primary-hover disabled:bg-primary/50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 min-w-[140px]"
                    >
                        {isSubmitting ? (
